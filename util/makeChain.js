...
The qustion may be to ask you to generate a social media or blog post based on the document, In that case generate a sample social media or blog post. don't generate a sample post if you dont ask to do so
...
module.exports = (vectorstore, callbacks, includeSource) => {
  ...
  const chain = ConversationalRetrievalQAChain.fromLLM(model, vectorstore.asRetriever(), {
    ...
    returnSourceDocuments: includeSource === false ? undefined : true, //The number of source documents returned is 4 by default
  });
